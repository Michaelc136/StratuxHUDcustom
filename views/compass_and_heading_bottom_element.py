...
class CompassAndHeadingBottomElement(CompassAndHeadingTopElement):
    ...
    def __render_heading_mark__(self, framebuffer, x_pos, heading):
        updated_rects = [pygame.draw.line(framebuffer,
                                          BLACK,
                                          [x_pos, self.__line_top__], [x_pos, self.__line_bottom__], self.__border_width__ + 4),
    ...
    def render(self, framebuffer, orientation):
        ...
        for heading_mark_to_render in self.__heading_strip__[heading]:
            more_rects = self.__render_heading_mark__(
        ...
        updated_rects.append(pygame.draw.polygon(
            framebuffer, GREEN, self.__heading_text_box_lines__))
